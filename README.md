...
|  ![Fasttext](https://fasttext.cc/docs/en/pretrained-vectors.html)             | Averaged word embeddings        | Biased: both weight 10% of doc length  | Biased: only A weight 10% of doc length | B doc embedding * weight(20) |
| ------------- |-------------| -----------------| ----|---- |
